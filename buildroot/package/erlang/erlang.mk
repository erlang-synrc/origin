...
ERLANG_CONF_OPT = --without-javac --enable-kernel-poll
...
#ifeq ($(BR2_i386),y)
#ERLANG_CONF_OPT += --enable-m32-build
#endif

# Remove source, example, gs and wx files from the target
ERLANG_REMOVE_PACKAGES = gs wx cosEvent cosEventDomain cosFileTransfer cosNotification cosProperty cosTime cosTransactions appmon tv
